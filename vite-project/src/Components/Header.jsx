...
const Header = () => {
  return (
    <>
    <div className="min-h-screen flex flex-row justify-between items-center lg:px-32 px-5 bg-[url('./assets/HImg4.jpg')] bg-cover bg-no-repeat " id='header'>
        <div className='w-full lg:w-2/3 space-y-5'>
            <div className=' font-semibold text-6xl'>

            {/*text content section */}    
            <div className='space-y-2 text-center sm:text-left p-4'>
            <h1 className='font-extrabold font-sans text-8xl bg-gradient-to-r from-green-900 to-gray-700 bg-clip-text text-transparent'>Discover, Create, and Enjoy </h1>
            <br />
